...
netlist = """* Marginal Cell (Task 2 W=0.24u) at VDD=0.7V, Temp=85C
...
with open("marginal_07v_85c.cir", "w") as f:
    f.write(netlist)

p = subprocess.run(["ngspice", "-b", "marginal_07v_85c.cir"], capture_output=True, text=True)
print(p.stdout)
